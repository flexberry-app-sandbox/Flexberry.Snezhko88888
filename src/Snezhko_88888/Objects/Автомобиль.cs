...
namespace IIS.Snezhko_88888
{
    ...
    public class Автомобиль : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Snezhko_88888.ТипАвтомобиля fТипАвтомобиля;
        ...
        public virtual IIS.Snezhko_88888.ТипАвтомобиля ТипАвтомобиля
        {
            get
            {
                ...
                IIS.Snezhko_88888.ТипАвтомобиля result = this.fТипАвтомобиля;
        ...
        /// <summary>
        /// мастеровая ссылка на шапку IIS.Snezhko_88888.Клиент.
        /// </summary>
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View АвтомобильE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("АвтомобильE", typeof(IIS.Snezhko_88888.Автомобиль));
                }
            }
        }
    }
    ...
    public class DetailArrayOfАвтомобиль : ICSSoft.STORMNET.DetailArray
    {
        ...
        // *** Start programmer edit section *** (IIS.Snezhko_88888.DetailArrayOfАвтомобиль members)

        // *** End programmer edit section *** (IIS.Snezhko_88888.DetailArrayOfАвтомобиль members)
        ...
        /// </summary>
        public DetailArrayOfАвтомобиль(IIS.Snezhko_88888.Клиент fКлиент) : 
                base(typeof(Автомобиль), ((ICSSoft.STORMNET.DataObject)(fКлиент)))
        {
        }
        
        public IIS.Snezhko_88888.Автомобиль this[int index]
        {
            get
            {
                return ((IIS.Snezhko_88888.Автомобиль)(this.ItemByIndex(index)));
            }
        }
        
        public virtual void Add(IIS.Snezhko_88888.Автомобиль dataobject)
        {
