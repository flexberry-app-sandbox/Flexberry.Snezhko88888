...
namespace IIS.Snezhko_88888
{
    ...
    public class СоставУслуги : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Snezhko_88888.Единицы fЕдиницы;
        
        private IIS.Snezhko_88888.Детали fДетали;
        
        private IIS.Snezhko_88888.Услуга fУслуга;
        ...
        public virtual IIS.Snezhko_88888.Единицы Единицы
        {
            get
            {
                ...
                IIS.Snezhko_88888.Единицы result = this.fЕдиницы;
        ...
        [PropertyStorage(new string[] {
                "Детали"})]
        [NotNull()]
        public virtual IIS.Snezhko_88888.Детали Детали
        {
            get
            {
                ...
                IIS.Snezhko_88888.Детали result = this.fДетали;
        ...
        /// <summary>
        /// мастеровая ссылка на шапку IIS.Snezhko_88888.Услуга.
        /// </summary>
        ...
        [PropertyStorage(new string[] {
                "Услуга"})]
        public virtual IIS.Snezhko_88888.Услуга Услуга
        {
            get
            {
                ...
                IIS.Snezhko_88888.Услуга result = this.fУслуга;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View СоставУслугиE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("СоставУслугиE", typeof(IIS.Snezhko_88888.СоставУслуги));
                }
            }
        }
    }
    ...
    public class DetailArrayOfСоставУслуги : ICSSoft.STORMNET.DetailArray
    {
        ...
        // *** Start programmer edit section *** (IIS.Snezhko_88888.DetailArrayOfСоставУслуги members)

        // *** End programmer edit section *** (IIS.Snezhko_88888.DetailArrayOfСоставУслуги members)
        ...
        /// </summary>
        public DetailArrayOfСоставУслуги(IIS.Snezhko_88888.Услуга fУслуга) : 
                base(typeof(СоставУслуги), ((ICSSoft.STORMNET.DataObject)(fУслуга)))
        {
        }
        
        public IIS.Snezhko_88888.СоставУслуги this[int index]
        {
            get
            {
                return ((IIS.Snezhko_88888.СоставУслуги)(this.ItemByIndex(index)));
            }
        }
        
        public virtual void Add(IIS.Snezhko_88888.СоставУслуги dataobject)
        {
